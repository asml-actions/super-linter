...
FROM python:3.13.0-alpine3.19 as clang-format
...
FROM python:3.13.0-alpine3.19 as python-builder
...
FROM python:3.13.0-alpine3.19 as npm-builder
...
FROM python:3.13.0-alpine3.19 as base_image
