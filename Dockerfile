...
FROM dart:3.4.3-sdk as dart

FROM python:3.12.4-alpine3.19 as clang-format
...
FROM python:3.12.4-alpine3.19 as python-builder
...
FROM python:3.12.4-alpine3.19 as npm-builder
...
FROM python:3.12.4-alpine3.19 as base_image
